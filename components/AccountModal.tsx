...
interface Props {
  ...
  onSubscribe: () => void;import React, { useState } from 'react';
import { SubscriptionInfo } from '../types';
import LegalContent from './LegalContent';
                ...
                <div className="space-y-4">
                  ...
                  <div className="p-6 rounded-3xl border border-amber-100 bg-amber-50/30">
                    ...
                    <div className="space-y-4">
                      <div className="flex gap-3">
                        ...
                        <div>
                          <p className="text-[10px] font-black text-slate-900 uppercase">Warning: No Testers Specified</p>
                          <p className="text-[9px] text-slate-500 font-medium">In Play Console, go to <span className="font-bold">Testing</span> → <span className="font-bold">Internal testing</span>. Click the <span className="font-bold">Testers</span> tab and add your email or a list. The app won't show up until you do this.</p>
                        </div>
                      </div>
                      <div className="flex gap-3">
                        <i className="fa-solid fa-code text-amber-500 mt-1 shrink-0"></i>
                        <div>
                          <p className="text-[10px] font-black text-slate-900 uppercase">Warning: No Deobfuscation File</p>
                          <p className="text-[9px] text-slate-500 font-medium">I've added the <span className="font-bold">mapping.txt</span> to your GitHub build artifacts. You can download it and upload it in the "App Bundles" section to help Google read crash logs.</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-6 rounded-3xl border border-blue-100 bg-blue-50/30">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <span className="text-[10px] font-black text-blue-600 uppercase tracking-widest">Launch Status</span>
                    </div>
                    <div className="space-y-4">
                      <div className="flex gap-3">
                        ...
                        <div>
                          <p className="text-[10px] font-black text-slate-900 uppercase">Version Increment</p>
                          <p className="text-[9px] text-slate-500 font-medium">Current Version Code in screenshot: 32. My script is now correctly auto-incrementing this for every push.</p>
                        </div>
                      </div>
                    </div>
                  </div>
